(defun c:GENPLAN ( / )
  ...
  (command "._LINE" "0,10398" "1737,10398" "")
  (command "._LINE" "1737,10398" "1737,12398" "")
  ...
  (command "._TEXT" "J" "MC" "868.5,11398.0" "300" "0" "Bathroom 2")
  (command "._TEXT" "J" "MC" "868.5,10898.0" "200" "0" "32.5 sq.ft")
