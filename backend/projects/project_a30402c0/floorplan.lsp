(defun c:GENPLAN ( / )
  ...
  (command "._LINE" "0,10398" "1724,10398" "")
  (command "._LINE" "1724,10398" "1724,12398" "")
  ...
  (command "._TEXT" "J" "MC" "862.0,11398.0" "300" "0" "Bathroom 2")
  (command "._TEXT" "J" "MC" "862.0,10898.0" "200" "0" "32 sq.ft")
